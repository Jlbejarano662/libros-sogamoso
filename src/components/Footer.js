...
const Footer = () => {
  //HTML
  return (
    <div className="bg-primary py-12 text-secondary">
      <div className="container mx-auto flex flex-wrap justify-between content-center">
        ...
        <section className="w-full md:w-[50%]">
          ...
          {/* Link to Instagram*/}
          <a
            href="https://www.instagram.com/librossogamoso/"
          ...
          {/* Link to Facebook*/}
          <a
            href="https://www.facebook.com/profile.php?id=100063623405752&mibextid=ZbWKwL"
            className="flex my-2 items-baseline text-lg"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          {/* Link to Twitter*/}
          <a
            href="https://twitter.com/librossogamoso?s=11&t=6AYgsBQu6rRUUneVuZdpJg"
            className="flex my-2 items-baseline text-lg"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <section className="w-full md:w-[50%] mt-2 md:my-0">
          ...
          <div className="flex  my-2 items-baseline text-lg">
            ...
            {/* location */}
            <p className="w-[90%]">
              Estamos ubicados cerca de la Uptc en la Cra 13B # 2B - 39 Sur,
              Sogamoso - Boyacá
            </p>
          </div>
          {/* cell phone */}
