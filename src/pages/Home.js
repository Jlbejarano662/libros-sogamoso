    ...
    <div className="mt-[3rem]">
      ...
      <section className="container mx-auto py-10 ">
        ...
        <div className='flex flex-col lg:flex-row items-center justify-start'>
          <div className="text-justify  text-xl lg:text-2xl text-secondary mb-8 lg:pr-10 lg:my-0 ">
            {/* text */}
            <p>
            ...
            <br></br>
            <p>
              Por eso en Libros Sogamoso además de libros originales tenemos libros replica de muy buena calidad, ofreciendo además diferentes promociones mes a mes.
            </p>
          </div>
          {/* image */}
      ...
      {/* What do we do? */}
      <section className="bg-space bg-no-repeat bg-cover bg-center">
      ...
      {/* phrase */}
      <section className=" bg-space bg-no-repeat bg-cover bg-center">
        <div className="container mx-auto py-40 md:py-20">
        {/* text */}
